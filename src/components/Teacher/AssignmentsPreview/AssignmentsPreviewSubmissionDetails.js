...
import { getTaskSubmissionAnswers, rateTaskAnswer } from "../../../lib/api/task-answer-api";
...
const AssignmentsPreviewSubmissionDetails = () => {
    ...
    const {
      ...
      data: getAnswersData,
    } = useHttp(getTaskSubmissionAnswers, true);
    ...
    return <div className={classes["assignment-details"]}>
